...
BLOG_AUTHOR = "El Flautista"  # (translatable)
BLOG_TITLE = "The Hamelin Theme"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hamelin_theme.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hamelin_theme.com/"
BLOG_EMAIL = "flute@hamelin.com"
BLOG_DESCRIPTION = "Creación del tema Hámelin para Nikola"  # (translatable)
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}"><button class="w3-button w3-padding-small w3-white w3-border">{read_more}…</a></button></p>'
